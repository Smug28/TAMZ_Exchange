...
public class NetworkActivity extends Activity {
    ...
    private class DownloadXmlTask extends AsyncTask<String, Void, List<Entry>> {
        ...
        protected void onPostExecute(List<Entry> result) {
            ...
            final CNBAdapter adapter = new CNBAdapter(context,
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    Entry value = (Entry) adapterView.getItemAtPosition(i);
                    Intent intent = new Intent(getContext(), ExchangeActivity.class);
                    intent.putExtra("fCurr", value.kod);
                    intent.putExtra("fCountry", value.stat);
                    intent.putExtra("fRate", value.cena);
                    intent.putExtra("fAmount", value.mnozstvi);
    ...
    private NetworkActivity getContext(){
        return this;
    }
